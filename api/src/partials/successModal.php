<div id="success-msg" class="rounded-lg p-6 w-11/12 max-w-[450px] absolute top-6 left-1/2 -translate-x-1/2  text-left bg-darkGrey text-white opacity-0 success-message-ani">
